...
plot(catdateweight$weight,col="black",main="cat weight by date (grid lines every ten days)",xlab="date (starting 20210623, at age four-to-six weeks)",
		ylab="weight (grams)",ylim=c(0,max(catdateweight$weight,na.rm=TRUE)*1.1),axes=FALSE)
	...
	abline(h=(catdateweight_interp$y[seq(10,10000,10)]),v=seq(10,10000,10),col="grey")
